...
from .ViewSets import  TTSVoiceViewSet, SentenceViewSet, NotificationSettingsViewSet, AIRecommendedSentenceViewSet,SentenceNotificationViewSet,NotificationCheckViewSet
...
router.register(r'notifications', NotificationCheckViewSet, basename='notification2') #patch 
